...
| 文档类型        | 文件路径                                                                         | 描述                                |
| --------------- | -------------------------------------------------------------------------------- | ----------------------------------- |
| 🎯 **核心功能** | [packages/core/README.md](packages.md)                               | 核心插件的详细使用说明和配置指南    |
...
| 🔌 **MCP 扩展** | [packages/mcp/README.md](_media/README.md)                                 | Model Context Protocol 扩展使用说明 |
...
本项目采用 MIT 许可证 - 查看 [LICENSE](_media/LICENSE) 文件了解详情。
