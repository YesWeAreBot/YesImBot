  ...
  return [
    {
      ...
      definition: {
        ...
        isAllowed: ({ enabledTools }) => enabledTools.includes("skill"),
    ...
    },
    {
      ...
      definition: {
        ...
        isAllowed: ({ enabledTools }) => enabledTools.includes("skill_read"),
    ...
    },
    {
      ...
      definition: {
        ...
        isAllowed: ({ enabledTools }) => enabledTools.includes("skill_search"),
