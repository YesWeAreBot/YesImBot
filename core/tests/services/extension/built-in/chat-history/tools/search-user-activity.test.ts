...
import { createSearchUserActivityTool } from "../../../../../../src/services/extension/built-in/chat-history/tools/search-user-activity.js";
import type {
  ChannelLocator,
  ChatHistoryConfig,
        ...
        "sess-002.jsonl":
          ...
          JSON.stringify({
            ...
            details: {
              ...
              source: { platform: "onebot", channelId: "group-456", sourceType: "group" },
        ...
        "sess-003.jsonl":
          ...
          JSON.stringify({
            ...
            details: {
              ...
              source: { platform: "onebot", channelId: "private-789", sourceType: "private" },
              actor: { id: "user-alice", name: "Alice" },
      ...
      manyMessages.push(
        JSON.stringify({
          ...
          details: {
            ...
            source: { platform: "onebot", channelId: "group-bulk", sourceType: "group" },
        ...
        "sess-004.jsonl":
          ...
          JSON.stringify({
            ...
            details: {
              ...
              source: { platform: "onebot", channelId: "group-789", sourceType: "group" },
        ...
        "sess-005.jsonl":
          ...
          JSON.stringify({
            ...
            details: {
              ...
              source: { platform: "onebot", channelId: "group-790", sourceType: "group" },
      ...
      JSON.stringify({
        ...
        JSON.stringify({
          ...
          details: {
            ...
            source: { platform: "onebot", channelId: "group-nometa", sourceType: "group" },
