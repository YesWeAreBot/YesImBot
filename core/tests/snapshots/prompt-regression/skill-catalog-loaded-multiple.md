...
<situation>
Scenario skill-catalog-loaded-multiple trigger=mention
...
- mention-aware: Handle mention trigger nuances. [loaded]
- search-service: Use search tools when needed. [loaded]
