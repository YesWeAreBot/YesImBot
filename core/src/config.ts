...
import { RuntimeControllerConfig } from "./internal/runtime";
import { WillingnessConfigSchema } from "./internal/runtime/behavior";
import { SessionStoreConfig } from "./internal/session";
import enUS from "./locales/en-US.json";
import zhCN from "./locales/zh-CN.json";
import { ExtensionConfig } from "./services/extension";
    ...
    runtimeSettings: Schema.object({
      ...
      delivery: Schema.object({
        ...
        segmentation: Schema.object({
          ...
          shortTextChars: Schema.number()
            .min(1)
            .max(500)
            .default(25)
            .description("短文本字符数阈值"),
        }).description("分段配置"),
